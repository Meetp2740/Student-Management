  ...
  return (
    <div className='max-w-lg mx-auto p-3'>
      ...
      <form className='flex flex-col'>
        ...
        <input defaultValue={currentUser.data.user.FirstName + " " + currentUser.data.user.LastName} type='text' placeholder='Username' id='username' className='mt-3 p-3 bg-slate-100 rounded-lg'></input>
        <input defaultValue={currentUser.data.user.Email} type='email' placeholder='Email' id='email' className='mt-3 p-3 bg-slate-100 rounded-lg'></input>
        <input defaultValue={currentUser.data.user.ContactNumber} type='number' placeholder='Contact Number' id='password' className='mt-3 p-3 bg-slate-100 rounded-lg'></input>
