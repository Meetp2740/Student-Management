        ...
        <div className='shadow-md w-full sticky top-0 left-0'>
            <div className='md:flex items-center justify-between bg-white py-4 md:px-10 px-7'>
                ...
                <ul className={`md:flex md:items-center md:pb-0 pb-12 absolute md:static bg-white md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${open ? 'top-14 ' : 'top-[-490px]'}`}>
                    ...
                    {
                        currentUser === null ? <li className="md:ml-8 text-xl md:my-0 my-7"><Link to="/sign-in" className=' text-gray-800 hover:text-gray-400 duration-500'>Sign-in</Link></li>
                        : ""
                    }
                    ...
                    {currentUser && currentUser?.data?.user?.Role === "management" ?
