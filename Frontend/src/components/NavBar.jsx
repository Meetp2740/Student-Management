...
function NavBar({ toggleSidebar }) {
    ...
    return (
        <nav className='h-16 flex justify-between items-center px-5 py-10 sticky top-0 bg-[#f5f7f8] w-full z-10'>
